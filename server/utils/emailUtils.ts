...
<body>
    <div class="container">
        <div class="header">
            <img src="${SITE_URL}/images/Optiqo_logo.png" alt="Optiqo" class="logo-img">
            <br>
        ...
        <div class="content">
            ...
            <div style="text-align: center;">
                <a href="${confirmationUrl}" class="cta-button" style="color: #ffffff !important; text-decoration: none;">
...
Complete your account setup by visiting: ${confirmationUrl}
...
Access your dashboard viewer account: ${confirmationUrl}
...
export function generateMagicLink(userId: string, email: string): string {
  ...
  return `${baseUrl}/auth/callback?token=${userId}&email=${encodeURIComponent(email)}`
}
